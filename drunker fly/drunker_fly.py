...
pygame.display.set_caption("Drunker Fly")
...
bird_up = pygame.image.load("lalat_up.png")
bird_down = pygame.image.load("lalat_down.png")
bird_mid = pygame.image.load("lalat_mid.png")
...
# Loading pipe image
pipe_img = pygame.image.load("wine.png")
